...
export const taskCreateSchema = z
  .object({
    ...
    area_tag: z.union([z.string().trim().max(40), z.null()]).optional(),
    schedule_locked: boolishSchema.optional(),
...
export const readingPatchSchema = z.discriminatedUnion("type", [
  ...
  z
    .object({
      type: z.literal("toggle_reading_book"),
      video_id: taskIdSchema,
      read: z.boolean(),
    })
    .strict(),
  ...
  z
    .object({
      type: z.literal("toggle_brochure"),
      video_id: taskIdSchema,
      read: z.boolean(),
    })
    .strict(),
  z
    .object({
      type: z.literal("toggle_watchtower"),
      video_id: taskIdSchema,
      read: z.boolean(),
    })
    .strict(),
